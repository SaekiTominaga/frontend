...
export default class ButtonCheckboxes extends HTMLButtonElement {
    ...
    connectedCallback() {
        ...
        if (targetsClass !== undefined) {
            const targetElements = document.getElementsByClassName(targetsClass);
            if (targetElements.length === 0) {
        ...
        if (targetsName !== undefined) {
            const targetElements = document.getElementsByName(targetsName);
            if (targetElements.length === 0) {
